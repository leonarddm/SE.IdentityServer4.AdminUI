...
using SE.IdentityServer4.STS.Identity.Configuration;
using SE.IdentityServer4.STS.Identity.Configuration.ApplicationParts;
using SE.IdentityServer4.STS.Identity.Configuration.Constants;
using SE.IdentityServer4.STS.Identity.Configuration.Interfaces;
using SE.IdentityServer4.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace SE.IdentityServer4.STS.Identity.Helpers
{
